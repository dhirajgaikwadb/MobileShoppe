...
for(int i=0;i<ck.length;i++)
{
	mail2=ck[0].getValue();
			...
			String mail =(String)session.getAttribute("mail1");
		    String sqlquery="select FirstName,LastName,Email,Phoneno,Address from Register where Email='"+mail2+"';";
